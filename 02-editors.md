...
>> I will use vim as my terminal editor of choice. It seemed to be the most intuitive of the three, and the note of
>> having the same editor experience across graphical and non-graphical environments was also a bonus.
...
>> I will use Atom as my graphical editor. I have previously used Sublime Text and Atom, and have found both to be comparable.
>> Opening a file via atom through the command line is ever so slightly faster. I like the idea of Atom being an open-source
>> editor as well. One interesting feature is using the multiple cursor feature by holding the cmd button. This allows you to
>> enter text in multiple places at once. Cmd+Shift+D allows you to duplicate the selected line of code. I haven't customized
>> my atom editor too much so far (only the color scheme), but I am looking to introduce some shortcuts to make me more
>> efficient with my work.
